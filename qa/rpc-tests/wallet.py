...
class WalletTest (BitcoinTestFramework):
    ...
    def run_test (self):
        ...
        # Send 210.000 BOKK from 0 to 2 using sendtoaddress call.
        ...
        # node0 should end up with 1.000.000 bokk in block rewards plus fees, but
        ...
        # Send 100000 BOKK with subtract fee from amount
