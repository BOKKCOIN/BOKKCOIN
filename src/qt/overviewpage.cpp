...
void OverviewPage::UpdateTip()
{
    QStringList tips = {
        ...
        tr("To see ongoing development and contribute, checkout Bokkcoin repository on GitHub!"),
        tr("Services that claim to double your bokkcoins are always ponzi schemes")
    };
