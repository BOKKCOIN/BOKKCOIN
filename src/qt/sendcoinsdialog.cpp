...
void SendCoinsDialog::updateFeeSectionControls()
{
    ...
    //mlumin: 5/2021 - this label actually gates the 'slider and smart fee' functionality, so turn it off for bokkcoin.
...
void SendCoinsDialog::updateGlobalFeeVariables()
{
    if (ui->radioSmartFee->isChecked())
    {
        ...
        // Bokkcoin: We manually set height well past the last hard fork here
...
void SendCoinsDialog::coinControlChangeEdited(const QString& text)
{
    if (model && model->getAddressTableModel())
    {
        ...
        {
            ui->labelCoinControlChangeLabel->setText(tr("Warning: Invalid Bokkcoin address"));
        }
        else // Valid address
        {
            CKeyID keyid;
