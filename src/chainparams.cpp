...
public:
    CMainParams() {
        ...
        // BIP34 is never enforced in Bokkcoin v2 blocks, so we enforce from v3
        ...
        // XXX: BIP heights and hashes all need to be updated to Bokkcoin values
        ...
        vSeeds.push_back(CDNSSeedData("multibokk.org", "seed.multibokk.org", true));
        vSeeds.push_back(CDNSSeedData("multibokk.org", "seed2.multibokk.org"));
