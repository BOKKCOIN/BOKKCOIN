...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || IsArgSet("-?") || IsArgSet("-h") || IsArgSet("-help"))
    {
        ...
        std::string strUsage = strprintf(_("%s bokkcoin-tx utility version"), _(PACKAGE_NAME)) + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  bokkcoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded bokkcoin transaction") + "\n" +
              "  bokkcoin-tx [options] -create [commands]   " + _("Create hex-encoded bokkcoin transaction") + "\n" +
              "\n";
