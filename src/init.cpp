...
void Shutdown()
{
    ...
    StopHTTPServer();
#ifdef ENABLE_WALLET
    // BOKKCOIN 1.14 TODO: ShutdownRPCMining();
    if (pwalletMain)
...
{
    const std::string URL_SOURCE_CODE = "<https://github.com/bokkcoin/bokkcoin>";
    const std::string URL_WEBSITE = "<https://bokkcoin.com>";
...
bool AppInitMain(boost::thread_group& threadGroup, CScheduler& scheduler)
{
    ...
    // BOKKCOIN: Do we need to do any RPC mining init here?
